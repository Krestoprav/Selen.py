...
"}")
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(110, 70, 250, 251))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Выгрузка Арт2"))
        self.pushButton_7.setText(_translate("MainWindow", "Объед"))
        self.pushButton.setText(_translate("MainWindow", "Выгрузка Арт"))
        # self.pushButton_3.setText(_translate("MainWindow", "9"))
        self.pushButton_8.setText(_translate("MainWindow", "Выгрузка Гарик"))
        self.pushButton_6.setText(_translate("MainWindow", "Подсчёт Гарик"))
        # self.pushButton_10.setText(_translate("MainWindow", "6"))
        self.pushButton_5.setText(_translate("MainWindow", "Выгрузка Вова"))
        self.pushButton_9.setText(_translate("MainWindow", "Подсчёт Вова"))
